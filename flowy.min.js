var flowy = function(e, t, l, i, n, o, r) {
    ...
    (flowy.load = function() {
                ...
                (flowy.moveBlock = function(e) {
                    if (
                        ...
                        n.push(i.filter((e) => e.id == t)[0]),
                            ...
                            .parentNode.remove();
                        for (
                            var l = i.filter((e) => e.parent == t), o = !1, r = [], d = []; !o;
        ...
        function T(e, t, l) {
            R || s.appendChild(e);
            for (
                var o = 0, r = 0, d = 0; d < i.filter((e) => e.parent == l[t]).length; d++
            ) {
            ...
            if (
                (I(c, c.x - i.filter((e) => e.id == l[t])[0].x + 20, B, l[t]), -1 != i.filter((e) => e.id == l[t])[0].parent)
            ) {
                for (var a = !1, g = l[t]; !a;)
        ...
        function M(e, t) {
            return (!!(e.className && e.className.split(" ").indexOf(t) >= 0) ||
                ...
                for (var l = i.map((e) => e.id), n = 0; n < i.length; n++)
                    if (
                        ((document.querySelector(
                            ...
                            u +
                            20 +
                            "px"), -1 != i.filter((e) => e.id == l[n])[0].parent)
                    ) {
        ...
        function D() {
            for (var e = i.map((e) => e.parent), t = 0; t < e.length; t++) {
                -1 == e[t] && t++;
                for (
                    var l = 0, n = 0, o = 0; o < i.filter((l) => l.parent == e[t]).length; o++
                ) {
